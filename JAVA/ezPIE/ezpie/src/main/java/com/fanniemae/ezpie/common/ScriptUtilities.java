...
public final class ScriptUtilities {
	...
	public static boolean evalToBoolean(String expression) {
		...
		try {
			...
			throw new PieException(String.format("Could not evaluate JavaScript expression \"%s\" to a boolean result. %s", expression, e.getMessage()), e);
		}
	...
	public static Object evaluate(String expression) {
		try {
			...
			throw new PieException(String.format("Could not evaluate JavaScript expression \"%s\". Reason: %s", expression, e.getMessage()), e);
		}
	}
}
